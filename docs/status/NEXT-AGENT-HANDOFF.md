...
- 완료 (2026-06-11): `AUTORIG-TEMPLATE-SPEC-001`(마스터+입시트 2장 확정), `AUTORIG-PIPELINE-CLI-001`(`run_autorig_pipeline.py`, 003 풀런 76분), `PIXI-RENDER-001`(PixiJS v8 WebGL 기본, 풀해상도 60fps).
- 다음 작업: `AUTORIG-CHARACTER-004`(초커 기본 풀런) → `AUTORIG-PLAYER-001` → `AUTORIG-ANCHOR-DETECT-001` → `AUTORIG-RIG-SCHEMA-001` → `AUTORIG-EDITOR-001`.
