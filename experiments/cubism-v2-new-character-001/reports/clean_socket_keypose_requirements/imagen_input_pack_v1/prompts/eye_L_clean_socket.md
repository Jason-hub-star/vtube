Asset: eye_L_clean_socket
Korean name: 왼눈 깨끗한 눈구멍/피부 밑색
Target group: eye_L
Target parameter: ParamEyeLOpen
...
Task:
Create clean eye-socket skin material for the specified left/right eye area. Remove iris, pupil, white of eye, highlight, and open-eye lash artifacts. Preserve surrounding skin gradient, blush, eyelid fold, and hair occlusion style. Output only the clean material needed under closed eyelids.
