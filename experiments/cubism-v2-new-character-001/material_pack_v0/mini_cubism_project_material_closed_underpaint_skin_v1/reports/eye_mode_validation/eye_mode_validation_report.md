...
- Status: `PASS`
- Project: `/Users/family/jason/Vtube/experiments/cubism-v2-new-character-001/material_pack_v0/mini_cubism_project_material_closed_underpaint_skin_v1`
...
| 왼눈 닫힘 (`eye_l_closed`) | `PASS` | 0 | 15991 |
| 오른눈 닫힘 (`eye_r_closed`) | `PASS` | 0 | 17648 |
| 양눈 닫힘 (`both_eyes_closed`) | `PASS` | 0 | 33639 |
