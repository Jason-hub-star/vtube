...
Generated: 2026-06-05T14:49:43.858260+00:00
...
| Momose Hiyori | KEEP | standard Cubism 3.0 model, deformer structure, parameter structure, hair skinning | models=2, art=149, param=78, warp=62, rot=56, key=382, phys=11, motion=10, psd=0 |
| Niziiro Mao | KEEP | blend shapes, multiply and screen color, mouth, eyebrow, and hair additive shape differences, wide face motion range | models=1, art=262, param=128, warp=116, rot=59, key=497, phys=16, motion=7, psd=0 |
| Mark-kun | KEEP | simple deformer structure, simple parameter structure, physics, eye blink, PSD availability | models=1, art=33, param=27, warp=26, rot=13, key=90, phys=0, motion=0, psd=0 |
...
| Niziiro Mao | KEEP | blend shapes, multiply and screen color, mouth, eyebrow, and hair additive shape differences, wide face motion range | models=1, art=262, param=128, warp=116, rot=59, key=497, phys=16, motion=7, psd=0 |
| Mark-kun | REFERENCE_ONLY | simple deformer structure, simple parameter structure, physics, eye blink, PSD availability | models=1, art=33, param=27, warp=26, rot=13, key=90, phys=0, motion=0, psd=0 |
...
| Rice Glassfield | REFERENCE_ONLY | extended interpolation, inverted mask, forelock and fire effects | models=2, art=183, param=96, warp=58, rot=85, key=306, phys=9, motion=4, psd=0 |
...
| Haru | REFERENCE_ONLY | arm switching, clothing changes, voice and expression testing, overall Live2D feature test | models=1, art=114, param=33, warp=53, rot=34, key=267, phys=2, motion=23, psd=0 |
| Momose Hiyori | KEEP | standard Cubism 3.0 model, deformer structure, parameter structure, hair skinning | models=2, art=149, param=78, warp=62, rot=56, key=382, phys=11, motion=10, psd=0 |
...
| Ren Foster | REFERENCE_ONLY | Cubism 5.3 rich drawing, alpha blend masks, offscreen rendering, high-spec avatar expression | models=1, art=201, param=73, warp=128, rot=22, key=470, phys=16, motion=3, psd=0 |
...
| Miara | REFERENCE_ONLY | full-body avatar, voice motion, physics baseline | models=1, art=245, param=138, warp=93, rot=107, key=467, phys=19, motion=3, psd=0 |
| Hatsune Miku | KEEP | twin-tail hair skinning, smooth long hair motion | models=1, art=116, param=59, warp=27, rot=38, key=233, phys=13, motion=8, psd=0 |
| Natori | REFERENCE_ONLY | expressions, pose, motion baseline, physics baseline | models=1, art=176, param=96, warp=128, rot=52, key=407, phys=11, motion=8, psd=0 |
| Ren Foster | REFERENCE_ONLY | Cubism 5.3 rich drawing, alpha blend masks, offscreen rendering, high-spec avatar expression | models=1, art=201, param=73, warp=128, rot=22, key=470, phys=16, motion=3, psd=0 |
...
| Wanko | REFERENCE_ONLY | touch motions, non-human avatar runtime, physics baseline | models=1, art=78, param=25, warp=28, rot=6, key=85, phys=4, motion=12, psd=0 |
...
| Ren Foster | KEEP | Cubism 5.3 rich drawing, alpha blend masks, offscreen rendering, high-spec avatar expression | models=1, art=201, param=73, warp=128, rot=22, key=470, phys=16, motion=3, psd=0 |
| Rice Glassfield | KEEP | extended interpolation, inverted mask, forelock and fire effects | models=2, art=183, param=96, warp=58, rot=85, key=306, phys=9, motion=4, psd=0 |
| Tsumiki | KEEP | eyelid clipping mask, standard avatar motion | models=1, art=89, param=46, warp=67, rot=22, key=240, phys=7, motion=23, psd=0 |
| Unity-chan | KEEP | eyelid clipping mask, PSD layer reference, deformed character model | models=1, art=70, param=39, warp=40, rot=15, key=140, phys=3, motion=16, psd=2 |
...
| Haru | KEEP | arm switching, clothing changes, voice and expression testing, overall Live2D feature test | models=1, art=114, param=33, warp=53, rot=34, key=267, phys=2, motion=23, psd=0 |
...
| Niziiro Mao | REFERENCE_ONLY | blend shapes, multiply and screen color, mouth, eyebrow, and hair additive shape differences, wide face motion range | models=1, art=262, param=128, warp=116, rot=59, key=497, phys=16, motion=7, psd=0 |
| Natori | KEEP | expressions, pose, motion baseline, physics baseline | models=1, art=176, param=96, warp=128, rot=52, key=407, phys=11, motion=8, psd=0 |
| Nito | KEEP | two-head character, multiple variants in one model, large mouth expression, limbless comical motion | models=5, art=299, param=66, warp=137, rot=145, key=559, phys=0, motion=105, psd=0 |
| Parameter Controller Sample | REFERENCE_ONLY | parameter controller, target following, animation efficiency | models=2, art=3, param=27, warp=0, rot=1, key=2, phys=0, motion=0, psd=0 |
| Rice Glassfield | REFERENCE_ONLY | extended interpolation, inverted mask, forelock and fire effects | models=2, art=183, param=96, warp=58, rot=85, key=306, phys=9, motion=4, psd=0 |
| Shizuku | REFERENCE_ONLY | legacy sample structure, pose and physics baseline | models=1, art=187, param=45, warp=156, rot=27, key=358, phys=3, motion=4, psd=0 |
